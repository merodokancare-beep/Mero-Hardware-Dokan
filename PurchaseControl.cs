...
namespace MeroHardwareDokan
{
    public class PurchaseControl : UserControl
    {
        ...
        private void InitializeCart()
        {
            ...
            if (gridCart.Columns["CostPrice"] != null) gridCart.Columns["CostPrice"].FillWeight = 60;
            if (gridCart.Columns["SalesPrice"] != null) gridCart.Columns["SalesPrice"].FillWeight = 60;
            if (gridCart.Columns["TotalCost"] != null) gridCart.Columns["TotalCost"].FillWeight = 60;
        }
        ...
        private void TxtBarcode_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                try
                {
                    ...
                    {
                        conn.Open();
                        string sql = "SELECT Id, Name, Category, Unit, PurchasePrice, SalesPrice FROM Products WHERE Code = @code";
        ...
        private void ComboProduct_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    conn.Open();
                    using (SqlCommand cmd = new SqlCommand("SELECT PurchasePrice, SalesPrice, Unit FROM Products WHERE Id = @id", conn))
                    {
        ...
        private void BtnAddItem_Click(object sender, EventArgs e)
        {
            ...
            string code = fullText.Split(" - ")[0].Trim();
            string name = fullText.Substring(fullText.IndexOf(" - ") + 3).Trim();
            ...
            foreach (DataRow row in cartTable.Rows)
            {
                if ((int)row["ProductId"] == prodId)
                {
                    ...
                    row["TotalCost"] = (decimal)row["Qty"] * price;
                    found = true;
                    break;
                }
            }
            ...
            if (!found)
            {
                cartTable.Rows.Add(prodId, code, name, qty, unit, price, salesPrice, qty * price);
            }
        ...
        private class QuickAddProductDialog : Form
        {
            ...
            private void InitializeComponent()
            {
                ...
                this.ClientSize = new Size(480, 580); // Expanded for tax slab
                this.Font = Theme.MainFont;
                this.AutoScaleDimensions = new SizeF(7F, 15F);
                this.AutoScaleMode = AutoScaleMode.Font;
                this.AutoScroll = true;
                ...
                lblUnit.Location = new Point(250, startY + gapY);
                ...
                comboUnit.Location = new Point(250, startY + gapY + 20);
                ...
                btnSave.Location = new Point(20, 495); // Shifted down
                ...
                btnCancel.Location = new Point(240, 495); // Shifted down
                ...
                try
                {
                    using (SqlConnection conn = new SqlConnection(DatabaseHelper.ConnectionString))
                    {
                        ...
                        string sql = @"
                            ...
                            OUTPUT INSERTED.Id
                            VALUES (@code, @name, @category, @unit, @cost, @sales, 0, @minLevel, @taxPercent, @desc)";
