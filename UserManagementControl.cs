...
namespace MeroHardwareDokan
{
    public class UserManagementControl : UserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            gridUsers.Size = new Size(910, 460);
            gridUsers.Location = new Point(20, 115);
        ...
        private class UserDialog : Form
        {
            ...
            public UserDialog(int id, string username, string fullName, string role)
            {
                ...
                // When editing, password is not required. Change placeholder/label.
            ...
            private void InitializeComponent(string title)
            {
                ...
                if (userId == null) txtPassword.PlaceholderText = "Enter password";
